...
public class TestParseMessagesAsByteBuffer {
    public static void main(String[] args) throws InterruptedException {
        ...
        byte[] m6 = {0,0,0,0};
        // m = m1 + m2 + m3 + m4 + m5 + m6
        byte[] m = {0,0,0,1,1,0,0,0,1,2,0,0,0,9,5,1,2,3,4,5,6,7,8,0, 0, 0, 13, 6, 0,0,0,1,0,0,0,1,0,0,0,8,0, 0, 0, 13, 7, 0,0,0,1,0,0,0,1,0,0,0,8,0,0,0,0};
        ByteBuffer buf = ByteBuffer.allocate(1000);
        buf.put(m);
        List<Message> messages = Message.parserMessages(buf);
        for (Message me : messages){
            System.out.println(me.getTypeMessage());
        }
    }
}
